...
<html>
    <head>
        ...
        <script>
            ...
            function guardarCot()
            {
                var fechae,fechal,est;
                est=document.form.cbEstado.value;
                fechae=document.form.txtFechaE.value;
                fechal=document.form.txtFechaL.value;
                if(est=="")
                {
                    alert("Usted debe seleccionar el campo Estado");
                }
                else if(est=="Observado")
                {
                    alert("Usted no está autorizado a modificar al Estado Observado");
                }
                else if(fechae=="")
                {
            ...
            function detallar(id)
            {
                ...
                else
                {
                    ...
                    xmlhtpp+="<table border='4'>";
                        xmlhtpp+="<tr>";
                            xmlhtpp+="<td colspan='2'><center>Modificar Cotización</center></td>";
                        xmlhtpp+="</tr>";
                        xmlhtpp+="<tr>";
                        ...
                        xmlhtpp+="<tr>";
                            ...
                            xmlhtpp+="<td>";
                                <%
                                    if(request.getAttribute("objetoCot")!=null){  
                                %>
                                xmlhtpp+="<select name='cbEstado' disabled>";
                                    xmlhtpp+="<option value='<%=est%>' ><%=est%></option>";
                 
                                xmlhtpp+="</select>";
                                <%
                                    }else if(est.compareTo("Borrador")==0){
                                %>
                                
                                xmlhtpp+="<select name='cbEstado'>";
                                    xmlhtpp+="<option value=''>--Seleccionar--</option>";
                                    xmlhtpp+="<option value='Borrador' selected>Borrador</option>";
                                    xmlhtpp+="<option value='Enviado'>Enviado</option>";
                                    xmlhtpp+="<option value='Observado'>Observado</option>";
                                xmlhtpp+="</select>";
                                
                                <%
                                    }else if(est.compareTo("Enviado")==0){
                                %>
                                xmlhtpp+="<select name='cbEstado'>";
                                    xmlhtpp+="<option value=''>--Seleccionar--</option>";
                                    xmlhtpp+="<option value='Borrador' >Borrador</option>";
                                    xmlhtpp+="<option value='Enviado' selected>Enviado</option>";
                                    xmlhtpp+="<option value='Observado'>Observado</option>";
                                xmlhtpp+="</select>";            
                               <%
                                   }else{
                               %>
                                xmlhtpp+="<select name='cbEstado'>";
                                    ...
                                    xmlhtpp+="<option value='Borrador' >Borrador</option>";
                                    xmlhtpp+="<option value='Enviado' >Enviado</option>";
                                    xmlhtpp+="<option value='Observado' selected>Observado</option>";
                                xmlhtpp+="</select>";        
                               <%
                                   }
                               %>
    ...
    <body onload="foco()">
        <form name="form">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">  
               ...
               <div class="CabeceraMenus">Modificación de Cotización</div>
            </nav>
            <center>
                <div class="DivPrincipalMantenimientoRegistrar">
                    ...
                    <table border="4" cellpadding="5">
                        <tr>
                            <td colspan="4"><center>Modificar Proveedor</center></td>
                        </tr>
                        <tr>
